...
const Dashboard = () => {
    ...
    return (
        <div className='w-full flex flex-col md:flex-row gap-3 mb-4'>
            <div className="w-full md:w-1/4 h-fit flex flex-col gap-3 p-6 bg-custom-primary-2 rounded-lg md:m-4">
            ...
            <div className='w-full md:w-3/4 flex flex-col gap-1 items-center'>
                <h2 className='text-xl font-bold text-white pb-2 mt-4'>Historial de ordenes de compra</h2>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-2 justify-evenly'>
