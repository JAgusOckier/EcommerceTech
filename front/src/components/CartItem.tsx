...
const CartItem: React.FC<CartItemProps> = (item) => {
  return (
    ...
    <div className="flex items-center justify-between gap-4 text-gray-900 m-1 p-4 bg-emerald-200 shadow-md rounded-lg">
      ...
      <div className="flex gap-3 items-center">
        <div>
        <p className="text-gray-600 hidden md:block">Cantidad: </p>
